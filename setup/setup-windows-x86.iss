...
Source: "..\src\Wexflow.Clients.WindowsService\bin\Release\Wexflow.Tasks.ExecCs.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\Wexflow.Clients.WindowsService\bin\Release\Wexflow.Tasks.ExecVb.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\Wexflow.Clients.WindowsService\bin\Release\Wexflow.Tasks.HttpPost.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\Wexflow.Clients.WindowsService\bin\Release\Wexflow.Tasks.HttpPut.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\Wexflow.Clients.WindowsService\bin\Release\Wexflow.Tasks.HttpPatch.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\Wexflow.Clients.WindowsService\bin\Release\Wexflow.Tasks.HttpDelete.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\Wexflow.Clients.WindowsService\bin\Release\Wexflow.Tasks.UglifyJs.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\Wexflow.Clients.WindowsService\bin\Release\Wexflow.Tasks.UglifyCss.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\Wexflow.Clients.WindowsService\bin\Release\Wexflow.Tasks.UglifyHtml.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\Wexflow.Clients.WindowsService\bin\Release\Wexflow.Tasks.HtmlToText.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\Wexflow.Clients.WindowsService\bin\Release\Wexflow.Tasks.HttpGet.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\Wexflow.Clients.WindowsService\bin\Release\Wexflow.Tasks.ScssToCss.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\Wexflow.Clients.WindowsService\bin\Release\Wexflow.Tasks.YamlToJson.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\Wexflow.Clients.WindowsService\bin\Release\Wexflow.Tasks.JsonToYaml.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\Wexflow.Clients.WindowsService\bin\Release\Wexflow.Tasks.CsvToJson.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\Wexflow.Clients.WindowsService\bin\Release\Wexflow.Tasks.CsvToYaml.dll"; DestDir: "{app}"; Flags: ignoreversion
