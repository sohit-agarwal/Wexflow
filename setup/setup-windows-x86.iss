...
Source: "..\src\dotnet\Wexflow.Tasks.Ftp\bin\x86\Release\FluentFTP.dll"; DestDir: "{app}"; Flags: ignoreversion
...
Source: "..\src\dotnet\Wexflow.Tasks.Tar\bin\x86\Release\ICSharpCode.SharpZipLib.dll"; DestDir: "{app}"; Flags: ignoreversion
;Source: "..\libs\log4net.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\Release\log4net.dll"; DestDir: "{app}"; Flags: ignoreversion
;Source: "..\libs\Newtonsoft.Json.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\Release\Newtonsoft.Json.dll"; DestDir: "{app}"; Flags: ignoreversion
;Source: "..\libs\Renci.SshNet.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Tasks.Ftp\bin\x86\Release\Renci.SshNet.dll"; DestDir: "{app}"; Flags: ignoreversion
...
Source: "..\src\dotnet\Wexflow.Tasks.Xslt\bin\x86\Release\saxon9he.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Tasks.Xslt\bin\x86\Release\saxon9he-api.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Tasks.Xslt\bin\x86\Release\IKVM.OpenJDK.Charsets.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Tasks.Xslt\bin\x86\Release\IKVM.OpenJDK.Core.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Tasks.Xslt\bin\x86\Release\IKVM.OpenJDK.Security.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Tasks.Xslt\bin\x86\Release\IKVM.OpenJDK.Text.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Tasks.Xslt\bin\x86\Release\IKVM.OpenJDK.Util.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Tasks.Xslt\bin\x86\Release\IKVM.OpenJDK.XML.API.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Tasks.Xslt\bin\x86\Release\IKVM.Runtime.dll"; DestDir: "{app}"; Flags: ignoreversion
...
Source: "..\src\dotnet\Wexflow.Tasks.IsoCreator\bin\x86\Release\DiscUtils.Common.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Tasks.IsoCreator\bin\x86\Release\DiscUtils.dll"; DestDir: "{app}"; Flags: ignoreversion
...
; PostgreSQL
Source: "..\src\dotnet\Wexflow.Core.PostgreSQL\bin\x86\Release\*.dll"; DestDir: "{app}"; Flags: ignoreversion

; SQLServer
Source: "..\src\dotnet\Wexflow.Core.SQLServer\bin\x86\Release\Wexflow.Core.SQLServer.dll"; DestDir: "{app}"; Flags: ignoreversion

; MySQL
Source: "..\src\dotnet\Wexflow.Core.MySQL\bin\x86\Release\*.dll"; DestDir: "{app}"; Flags: ignoreversion

; SQLite
Source: "..\src\dotnet\Wexflow.Core.SQLite\bin\x86\Release\*.dll"; DestDir: "{app}"; Flags: ignoreversion
...
; Twilio
;Source: "..\src\dotnet\Wexflow.Tasks.Twilio\bin\x86\Release\"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Tasks.Twilio\bin\x86\Release\Microsoft.IdentityModel.JsonWebTokens.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Tasks.Twilio\bin\x86\Release\Microsoft.IdentityModel.Logging.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Tasks.Twilio\bin\x86\Release\Microsoft.IdentityModel.Tokens.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Tasks.Twilio\bin\x86\Release\System.IdentityModel.Tokens.Jwt.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Tasks.Twilio\bin\x86\Release\Twilio.dll"; DestDir: "{app}"; Flags: ignoreversion
;Source: "..\src\dotnet\Wexflow.Tasks.Twilio\bin\x86\Release\Newtonsoft.Json.dll"; DestDir: "{app}"; Flags: ignoreversion
...
Source: "..\src\dotnet\Wexflow.Server\bin\Release\Wexflow.Tasks.Twilio.dll"; DestDir: "{app}"; Flags: ignoreversion
