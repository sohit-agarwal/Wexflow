...
- **YouTube task:** Create a task that allows to upload, edit or delete videos on YouTube. This task should use YouTube Data API client library for .NET.
