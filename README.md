...
Take a look at the brand new [version 4.9](https://github.com/aelassas/Wexflow/releases/tag/v4.9). This version includes a full upgrade to Nancy, an addition of basic access authentication to all [RESTful APIs](https://github.com/aelassas/Wexflow/wiki/RESTful-API), new built-in tasks, bug fixes, performance enhancements and under the hood updates.
