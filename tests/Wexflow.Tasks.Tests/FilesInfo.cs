...
namespace Wexflow.Tasks.Tests
{
    ...
    public class FilesInfo
    {
        ...
        private static string _expectedResult =
            ...
            + "<Files>\r\n"
            + "  <File path=\"C:\\WexflowTesting\\file1.txt\" name=\"file1.txt\" renameToOrName=\"file1.txt\" createdOn=\"{0}\" lastWriteOn=\"{1}\" lastAcessOn=\"{2}\" isReadOnly=\"false\" length=\"27\" attributes=\"Archive\" />\r\n"
